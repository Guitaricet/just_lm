...
#
# Based on https://github.com/huggingface/transformers/blob/c4deb7b3ae64f6a4bd0e86cdbd3985de4d24b46e/examples/flax/language-modeling/run_clm_flax.py
"""
...
class TrainingArguments:
    ...
    wandb_project: str = field(default="just_lm", metadata={"help": "WandB project name to log results to"})
...
def write_train_metric(train_metrics, step):
...
def main():
    ...
    if model_args.init_range is not None:
        config.initializer_range = model_args.init_range
    ...
    for epoch in epochs:
        ...
        for step in tqdm(range(steps_per_epoch), desc="Training...", position=1, leave=False):
            ...
            if cur_step % training_args.logging_steps == 0 and cur_step > 0:
                ...
                if jax.process_index() == 0:
                    write_train_metric(train_metrics, cur_step)
